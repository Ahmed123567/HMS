                                    ...
                                    <div class="counter-status d-flex md-mb-0">
                                        ...
                                        <div class="counter-icon text-primary">
                                            <a data-url="{{ route('autoDoctor.covid') }}"style="cursor: pointer"
                                                data-title="Covid Check" class="modal_btn"><i class="icon icon-docs"></i></a>
                                        </div>
                                        <div class="mr-auto">
                                            <a data-url="{{ route('autoDoctor.covid') }}" style="cursor: pointer"
                                                data-title="Covid Check" class="modal_btn">
                                                <h5 class="tx-13 mt-4 mx-2 tx-white-8 mb-3">Covid Check</h5>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="counter-status d-flex md-mb-0">
                                        ...
                                        <div class="counter-icon text-primary">
                                            <a data-url="{{ route('autoDoctor.brainTumor') }}"style="cursor: pointer"
                                                data-title="BrainTumor Check" class="modal_btn"><i class="icon icon-docs"></i></a>
                                        </div>
                                        <div class="mr-auto">
                                            <a data-url="{{ route('autoDoctor.brainTumor') }}" style="cursor: pointer"
                                                data-title="BrainTumor Check" class="modal_btn">
                                                <h5 class="tx-13 mt-4 mx-2 tx-white-8 mb-3">BrainTumor Check</h5>
                                            </a>
                                        </div>
                                    </div>
                                </div>
