...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Management</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/Laboratory </span>
            </div>
        </div>
    ...
    <div class="card">
        <div class="card-header pb-0">
            <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-info btn-with-icon" data-target="#modaldemo3" data-toggle="modal"><i class="typcn typcn-document-add"></i> upload</button>
            </div>
        </div>
        <div class="card-body">
                ...
                <table id="lab-pending" class="table mg-b-0 text-md-nowrap">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><button class="btn btn-info btn-icon"><i class="typcn typcn-edit"></i></button></td>
                            <td>
                                <button class="btn btn-info btn-icon" data-toggle="modal" data-target="#modal4{{$lab->patient_id}}">
                                   U
                                </button>
                            </td>
                        </tr>
...
<div class="col-xl-12">
    <div class="card">
        <div class="card-header pb-0">
            <div class="d-flex justify-content-between">
                <h4 class="card-title mg-b-0">Finished</h4>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table id = "lab-finished" class="table mg-b-0 text-md-nowrap">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{$lab->department_name}}</td>
                            <td><button class="btn btn-info btn-icon"><i class="typcn typcn-edit"></i></button></td>
                            <td><a class="btn btn-info" href="{{ asset('storage/images/'.$lab->attachements) }}" target="_blank">Show Attachement</a>
