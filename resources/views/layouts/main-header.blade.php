...
$id = auth()->user()->id;
$messages = ChMessage::where('to_id', $id)
    ->where('seen', 0)
    ->get();
                        ...
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                ...
                                <a href="\MarkAsRead_all"
                                    class="badge badge-pill badge-warning mr-auto my-auto float-left">Mark All Read</a>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="count">You
                                have {{ $messages->count() }} unread messages</p>
                        </div>
                                ...
                                @if ($message->sender_id != auth()->id() && $message->seen == 0)
                                    <a href="#" class="p-3 d-flex border-bottom">
                                        <div class="drop-img cover-image"
                                            data-image-src="{{ URL::asset('assets/img/faces/admin.jpg') }}">
          ...
          <a href="{{ url('analysis') }}" >lab</a>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href="">
							@if (!Illuminate\Support\Facades\File::exists(auth()->user()->imageStorePath()))
								<img alt="" src="{{ asset('storage/images/default.jpg') }}"
									class="">
							@else
								<img alt="" src="{{ URL::asset(auth()->user()->imageUrl()) }}"
									class="">
							@endif
						</a>
