...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header text-center active">
        <img src="{{ asset('assets/img/brand/favicon.png') }}" class="mt-1" width="30" alt="">
        <h5 style="color: #0162e8" class="mt-3 mx-2">VitalProtal</h5>
    </div>
            ...
            @if (auth()->user()->hasRole("Receptionist", "Admin"))
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ route('appointment.reserve.index') }}">Appointment
                                Resrvation</a></li>
                    </ul>
                </li>
